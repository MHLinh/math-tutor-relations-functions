...
/**
 * A component displaying whether the relation is a total order.
 * Displays missing properties for it to be a total order.
 * Allows user to choose input type for the relation.
 * Allows user to clear, save, and load the relation.
 */
export function RelationTotalOrder() {
  ...
  return (
    <Container className={classes.container}>
      ...
      <Box className={classes.box}>
        <RelationTotalOrderCheck matrix={relation} />
      </Box>
      <Box className={classes.box}>
        <RelationInput 
