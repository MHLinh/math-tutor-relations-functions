...
/**
 * A component displaying whether the relation is a partial order.
 * Displays missing properties for it to be a partial order.
 * Allows user to choose input type for the relation.
 * Allows user to clear, save, and load the relation.
 */
export function RelationPartialOrder() {
  ...
  return (
    <Container className={classes.container}>
      ...
      <Box className={classes.box}>
        <RelationPartialOrderCheck matrix={relation} />
      </Box>
      <Box className={classes.box}>
        <RelationInput 
