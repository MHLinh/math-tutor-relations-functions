...
import { RelationReflexiveCheck } from "./relation-reflexive-check"

/**
 * A component displaying whether the relation is reflexive.
 * Displays missing pairs for the relation to be reflexive.
...
export function RelationReflexive() {
  ...
  return (
    <Container className={classes.container}>
      ...
      <Box className={classes.box}>
        <RelationReflexiveCheck matrix={relation} />
      </Box>
      <Box className={classes.box}>
        <RelationInput 
